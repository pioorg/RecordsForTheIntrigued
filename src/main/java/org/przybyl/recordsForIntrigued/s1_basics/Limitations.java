...
package org.przybyl.recordsForIntrigued.s1_basics;
...
record ConstructorsNeedTheSameVisibility(int aComponent) {
	// canonical constructors access cannot be more restrictive than class visibility
	/*private*/ ConstructorsNeedTheSameVisibility {
	}

	//non-canonical constructors can have reduced visibility
	private ConstructorsNeedTheSameVisibility(String custom) {
